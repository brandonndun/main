    ...
    <div class="container">
        ...
        <div class="row" style="margin-top: -120px;">
            <div class="col">
                ...
                <button type="button" class="btn d-flex justify-content-center align-center" style="background-color: #D0F2A4; align-items: center; position: absolute; left: 45%; margin-top: 20px;">Edit Photo</button>
            </div>
            <div class="col" style="margin-top: 230px">
                ...
                <button type="button" class="btn d-flex justify-content-center align-center" style="background-color: #D0F2A4; margin-top: 106px; position: absolute; align-items: right; right: 19%;">Save</button>
            </div>
        </div>
    </div>
</body>
