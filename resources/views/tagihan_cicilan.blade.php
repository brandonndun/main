...
<body style="overflow-x: hidden; margin-left:-65px;">
    ...
    <div class="laporan-tagihan"
        style="width: 1179px;; border: solid; margin-left: 167px; margin-top: 51px; background-color: #57B846; padding: 75px; border-radius: 31px"
        id="laporan-tagihan">
        <div class="icon" style="position: relative; width: 20%; height: 10px">
            <img src="img/house-door.svg" style="height: 39px; margin-top: -57px">
            <h4 class="nama-reseller" style="margin-left: -50px; margin-top: -3px; font-family : quicksand">Nama
                Reseller</h4>
            <h4 class="tagihan"
                style="margin-left: 285px; margin-top: -111px; font-family : quicksand; white-space: nowrap">Tagihan
            </h4>
            <h4 class="angka"
                style="margin-left: 252px; margin-top: 44px; font-family : quicksand; white-space: nowrap">Rp 1.500.000
            </h4>
            <div
                style="width: 2px; height: 100px; position: absolute; background: black; margin-left: 432px; margin-top: -105px">
            </div>
            <h4 class="dibayar"
                style="margin-left: 489px; margin-top: -111px; font-family : quicksand; white-space: nowrap">Sudah
                Dibayar</h4>
            <h4 class="angka2"
                style="margin-left: 507px; margin-top: 44px; font-family : quicksand; white-space: nowrap">Rp 500.000
            </h4>
            <div
                style="width: 2px; height: 100px; position: absolute; background: black; margin-left: 708px; margin-top: -101px">
            </div>
            <h4 class="kekurangan-pembayaran"
                style="margin-left: 764px; margin-top: -111px; font-family : quicksand; white-space: nowrap">Kekurangan
                Pembayaran</h4>
            <h4 class="angka3"
                style="margin-left: 836px; margin-top: 44px; font-family : quicksand; white-space: nowrap; color: red">
                Rp 1.000.000</h4>
        </div>
    </div>
    <div class="riwayat-pembayaran"
        ...
        <div
            style="width: 1179px; height: 2px; position: absolute; background: black; margin-left: -188px; margin-top: -1px">
        </div>
        <div
            style="width: 1179px; height: 2px; position: absolute; background: black; margin-left: -188px; margin-top: 88px">
        </div>
        <h4 class="riwayat-pembayaran" style="margin-left: -162px; margin-top: -174px; font-family : quicksand">Riwayat
            Pembayaran</h4>
        ...
        <h4 class="metode" style="margin-left: 724px; margin-top: -37px; font-family : quicksand; white-space: nowrap">
