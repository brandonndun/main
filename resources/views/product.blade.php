...
<body> @include('navbar') <h1 style="text-align:center;margin-top:25px; font-family: quicksand"> Product</h1>
    <div style="padding-bottom:30px">
        <a class="btn btn-primary" href="/insertproduct" role="button"
            style="margin-left: 77% ;box-shadow: 3px 3px 2px grey; background-color: #D0F2A4; width:11%; color:black; font-family: quicksand; border: none">Insert
            Produk Baru</a>
            ...
            <div class="row" style=" width:82% ; text-align:center ; margin-left:10% ;  padding-bottom: 50px; ">
                ...
                <div class='col'>
                    <div class="produk" style="box-shadow: 15px 15px 5px grey; border-radius:0%; width: 338px">
                        ...
                        <h2 style="text-align:center ; padding-bottom:5px; font-family: quicksand">
                            {{$produk -> NAMA_PRODUK}}</h2>
                        <h2 style="text-align:center ; padding-bottom:5px; font-family: quicksand; font-size: 18px;">
                            {{$produk -> JUMLAH}}</h2>
                        <h2 style="text-align:center ; padding-bottom:5px; font-family: quicksand; font-size: 18px">
                            {{$produk -> WAREHOUSE_ASAL}}</h2>

                        <h2 style="text-align:center ; padding-bottom:5px; font-family: quicksand; font-size: 18px">
                            {{$produk -> KETERANGAN}}</h2>
                                ...
                                <div class="col">
                                    <form action="/addproduct" method="POST">
                                        ...
                                        <input type="submit" class="btn btn-primary"
                                            style="width:80% ; box-shadow: 3px 3px 2px grey; background-color: #D0F2A4; color: black; border: none; font-family: quicksand"
                                            value="Add">
                                    </form>
                                </div>

                                <div class="col">
                                    <a class="btn btn-primary" href="{{url('reduceproduct/'.$produk->ID_PRODUK)}}"
                                        role="button"
