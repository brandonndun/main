                    ...
                    <div class="card-body" style="background-color: #57B846;">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-6 d-flex justify-content-center">
                                <a href="/editproduct" class="btn ml-5"
                                    style="background-color: #D0F2A4; color:black;">Edit</a>
                            </div>
                            <div class="col-6 d-flex justify-content-center">
                        ...
                        <div class="row d-flex justify-content-around mt-3">
                            <div class="col-6 col-md-4 d-flex justify-content-center">
                                <a href="/addproduct" class="btn"
                                    style="background-color: #D0F2A4; color:black;">Add</a>
                            </div>
                            <div class="col-6 col-md-4 d-flex justify-content-center">
                                <a href="/reduceproduct" class="btn"
                                    style="background-color: #D0F2A4; color:black;">Reduce</a>
                            </div>
                            <div class="col-6 col-md-4 d-flex justify-content-center">
                                <a href="/sendproduct" class="btn"
                                    style="background-color: #D0F2A4; color:black;">Send</a>
                            </div>
                        </div>
                    </div>
                </div>
