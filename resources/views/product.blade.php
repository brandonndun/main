<html lang="en">
  ...
  <body> @include('navbar') <h1 style="text-align:center;margin-top:25px; font-family: quicksand"> Product</h1>
    ...
    <div>
      <div class="row" style=" width:82% ; text-align:center ; margin-left:10% ;  padding-bottom: 50px; margin-top: 22px "> @foreach($product as $produk) <div class='col'>
          <div class="produk" style="box-shadow: 15px 15px 5px grey; border-radius:0%; width: 338px">
            ...
            <div class="tombol">
              <div class="row" style="width:60%;margin-left:20%; padding-bottom:20px">
                <form action="/editproduct" method="post"> @csrf <div class="col">
                ...
                <form action="/deleteproduk" method="post"> @csrf <div class="col">
                    <input type="hidden" name="idpencatatan" value="{{$produk -> ID_PENCATATAN}}" />
              ...
              <div class="row" style="width:90%;margin-left:5%; padding-bottom:30px">
                <div class="col">
                  <form action="/addproduct" method="POST"> @csrf <input type="hidden" name="id_add_produk" value="{{$produk->ID_PRODUK}}">
        ...
        </div> @endforeach <footer class="page-footer font-large special-color-dark pt-4" style="margin-top : 100px;">
          <div class="container">
            <ul class="list-unstyled list-inline text-center">
              <li class="list-inline-item">
                <a class="btn-floating btn-fb mx-1">
                  <a href="https://www.facebook.com/Durianasunmedan" class="btn-floating btn-lg btn-fb" type="button" role="button">
              ...
              <li class="list-inline-item">
                <a class="btn-floating btn-tw mx-1">
                  <a href="https://www.instagram.com/durianaroisby/" class="btn-floating btn-lg btn-ins" type="button" role="button">
              ...
              <li class="list-inline-item">
                <a class="btn-floating btn-li mx-1">
                  <a href="https://www.youtube.com/channel/UC3Po2UCPQAPj0fgohUGQwkg" class="btn-floating btn-lg btn-yt" type="button" role="button">
              ...
              <li class="list-inline-item">
                <a class="btn-floating btn-dribbble mx-1">
                  <a href="https://api.whatsapp.com/send/?phone=628176867685&text&app_absent=0" class="btn-floating btn-lg btn-whatsapp" type="button" role="button">
          ...
          <div class="footer-copyright text-center py-3">Durian Asun Surabaya </div>
        </footer>
